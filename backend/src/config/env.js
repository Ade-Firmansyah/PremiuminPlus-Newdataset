...
const env = {
  ...
  ALLOW_LEGACY_SQL_IN_PRODUCTION: String(process.env.ALLOW_LEGACY_SQL_IN_PRODUCTION || '').toLowerCase() === 'true',
  ...
  PRODUCTS_CACHE_MS: envMs('PRODUCTS_CACHE_MS', 15000, 5000),
  BOT_CATALOG_CACHE_MS: envMs('BOT_CATALOG_CACHE_MS', 15000, 5000),
