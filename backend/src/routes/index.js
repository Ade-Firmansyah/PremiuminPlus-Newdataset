...
import { adminCreateProduct, adminDeleteProduct, adminUpdateProduct, getProducts } from '../modules/product/product.controller.js';
...
import { dashboardSummary, me, saldo, saldoLogs, topAccounts, updateMyPreferences } from '../modules/wallet/wallet.controller.js';
import {
  createAdminUser,
  deleteAdminUser,
  approveWithdraw,
...
router.post('/bot/order', auth, botCreateOrder);
router.post('/bot/payments', auth, botCreatePayment);
router.get('/bot/payments/:invoice/status', auth, botPaymentStatus);
router.post('/bot/payments/:invoice/cancel', auth, botPaymentCancel);
