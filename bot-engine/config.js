...
function normalizeWebCoreUrl(value) {
...
export const config = {
  ...
  webCoreUrl: normalizeWebCoreUrl(
  ...
  messageQueue: {
    maxSize: Number(process.env.BOT_MESSAGE_QUEUE_MAX || 100),
    recentTtlMs: envMs('BOT_MESSAGE_DEDUPE_TTL_MS', 60000, 10000),
  },
  reconnect: {
    minMs: 1500,
    maxMs: 60000,
