...
export function UserManagementPage({ apiKey: sessionApiKey }: { apiKey?: string } = {}) {
              ...
              <form className="mt-4 grid gap-3" autoComplete="off" onSubmit={(event) => event.preventDefault()}>
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    readOnly
                    className="mt-1.5 w-full cursor-not-allowed rounded-2xl border border-white/10 bg-[#0f0b15] px-4 py-3 text-sm text-white/55 outline-none"
