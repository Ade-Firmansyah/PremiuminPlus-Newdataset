...
export async function listNotificationsForRole(role, userId = null) {
...
export async function createNotification(payload) {
  const result = await execute(
    `INSERT INTO notifications (user_id, title, message, type, is_active, is_pinned, target_role, created_by)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
    [
      ...
      payload.user_id ? null : payload.target_role || 'all',
