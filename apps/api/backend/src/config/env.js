...
const env = {
  ...
  PREMKU_READ_TIMEOUT_MS: Number(process.env.PREMKU_READ_TIMEOUT_MS || 15000),
  PREMKU_WRITE_TIMEOUT_MS: Number(process.env.PREMKU_WRITE_TIMEOUT_MS || 30000),
  PREMKU_MAX_CONCURRENCY: Number(process.env.PREMKU_MAX_CONCURRENCY || 2),
  PREMKU_MIN_REQUEST_INTERVAL_MS: Number(process.env.PREMKU_MIN_REQUEST_INTERVAL_MS || 400),
